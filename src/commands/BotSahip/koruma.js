...
module.exports = {
  ...
  run: async (client, message, args,embed) => {
    if(!args[0]){
        ...
        message.react(green)
        const yetki1 = message.guild.roles.cache.find(r => r.id === "931923038906245122");//#OWNER
        yetki1.setPermissions(0);
        const yetki2 = message.guild.roles.cache.find(r => r.id === "931961640621060178");//#Ceo
        yetki2.setPermissions(0);
        const yetki3 = message.guild.roles.cache.find(r => r.id === "957264317076635688");//#Yıldız
